...
test('log filter match 0', (t) => {
  ...
  const params = testData0['fourtwenty_newFilter-req'].params[0]
  const inputLogs = testData0['fourtwenty_getLogs-res'].result
...
test('log filter - match 2', (t) => {
  ...
  const params = testData2['fourtwenty_newFilter-req'].params[0]
  const inputLogs = testData2['fourtwenty_getLogs-res'].result
...
test('log filter - match case-sensitive', (t) => {
  ...
  const params = testData3['fourtwenty_newFilter-req'].params[0]
  const inputLogs = testData3['fourtwenty_getLogs-res'].result
